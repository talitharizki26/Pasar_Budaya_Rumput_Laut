        ...
        <div id="top" style="overflow-x: hidden; margin-top: 150px;" bgcolor="#89C9D1">
            <div class="col-lg-12 ">
                <div class="contact-form">
                    ...
                    <h2 style="margin-top:20px;" align="center">Pesanan anda berstatus {{$data->konfirmasi_pesanan}}. Silahkan tunggu atau hubungi pembudidaya untuk info lebih lanjut.</h2>
                    @endforeach
                </div>
